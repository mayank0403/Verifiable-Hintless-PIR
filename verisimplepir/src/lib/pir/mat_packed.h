...
Matrix simplepir_matVecMulColPacked_variableCompression_MersenneMod(const PackedMatrix& a, const Matrix& b, const int logp, bool lazy = true);
Matrix simplepir_matVecMulColPacked_variableCompression_SolinasMod(const PackedMatrix& a, const Matrix& b, const int logp);
