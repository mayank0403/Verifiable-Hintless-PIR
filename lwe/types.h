...
using Integer = Elem; // No need to change anymore
using Integer64 = Elem64; // No need to change anymore
...
//using PlainInteger = uint16_t; // Not sure if this is needed anymore

// This *always* stays at 8 bits. Reinterpret cast in the inner product highway function is unstable for other types like 16 bits. 
using DBInteger = uint8_t;
