...
class Client {
 public:
  ...
  static absl::StatusOr<std::unique_ptr<Client>>
  CreateBSGS(const RlweParameters<RlweInteger>& parameters,
  ...
  GenerateGaloisKeyBSGS(absl::string_view prng_seed_sk) const;
 ...
 private:
  explicit Client(RlweParameters<RlweInteger> params,
                  std::string prng_seed_ct_pad, std::string prng_seed_gk_pad, std::string prng_seed_gk_pad_baby, std::string prng_seed_gk_pad_giant,
                  const RnsContext* rns_context,
      ...
      : params_(std::move(params)),
        ...
        prng_seed_gk_pad_baby_(std::move(prng_seed_gk_pad_baby)),
        prng_seed_gk_pad_giant_(std::move(prng_seed_gk_pad_giant)),
  ...
  std::string prng_seed_gk_pad_baby_;
  std::string prng_seed_gk_pad_giant_;
